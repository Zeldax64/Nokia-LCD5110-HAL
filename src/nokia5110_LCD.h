...
#else
#error "nokia5110 library was tested only on  STM32F0, STM32F1, STM32F3, STM32F4, STM32F7, STM32L0, STM32L4, STM32H7 MCU families. Please modify nokia5110_LCD.h if you know what you are doing. Also please send a pull request if it turns out the library works on other MCU's as well!"
#endif
